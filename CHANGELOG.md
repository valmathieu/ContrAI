...
- (scraper) Profile gains the pledge, scoreboard and state-resume keys, score-row declarer and winner fields, and a `[recorder]` section. See [scraper docs](docs/scraper/index.md).
