...
| **Mid-trick** | `Round.play_trick` → human turn         | Diamond seating (N top, E right, S bottom, W left). Live winner gets the gold pill. Hand row dim/green for legal vs. illegal plays. Belote holders gain a persistent `★ Belote` / `★ Rebelote` badge under their seat once they play the first / second K-or-Q of trump. |
